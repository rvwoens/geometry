...
class PolygonTest extends TestCase
{
	...
	public function testMakeWgs() {
		$rd = new Polygon('619487,228638|463000, 155000|377338, 17227');
		$wgs=$rd->makeWgsFromRd();
		$wgsstr=$wgs->polyString();
		$this->assertEquals('53.556313,6.498340|52.155174,5.387206|51.368417,3.408601|', $wgsstr);
	}
}
